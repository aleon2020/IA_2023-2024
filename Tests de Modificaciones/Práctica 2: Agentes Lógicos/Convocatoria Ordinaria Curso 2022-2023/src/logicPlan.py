...
# PREGUNTA 1: IMPLEMENTAR SENTENCIA LÓGICA PROPOSICIONAL

# EXPLICACIÓN DEL ALGORITMO:
# - Función sentence4():
# Sentencia 1: El Agente tiene flechas en el instante 1 si y solo si tiene flechas en 
# el instante 0 y no dispara flecha en el instante 0.
# Sentencia 2: Que el Agente dispare en el instante 0 y no tenga flecha en el instante 1 
# implica que el Wumpus está muerto en el instante 1.
# Sentencia 3: Que el Wumpus no esté muerto en el instante 1, el Agente no dispare en el 
# instante 0 y el Agente tenga flecha en el instante 0 implica que el Agente tiene flecha 
# en el instante 1.
# Sentencia 4: El Agente no dispara la flecha en el instante 0 y el Wumpus no está muerto 
# en el tiempo 1 y el Agente tiene flecha en el instante 1.
# Por último, devuelve la conjunción de las sentencias anteriores.
        
def sentence4() -> Expr:

    A = logic.PropSymbolExpr("AgenteFlecha", time = 0)
    B = logic.PropSymbolExpr("AgenteFlecha", time = 1)
    C = logic.PropSymbolExpr("AgenteDispara", time = 0)
    D = logic.PropSymbolExpr("WumpusMuerto", time = 1)
...
# PREGUNTA 2: IMPLEMENTAR SENTENCIA LÓGICA PROPOSICIONAL

# EXPLICACIÓN DEL ALGORITMO:
# - Función sentence5():
# Sentencia 1: El Agente está en la posición (2,1) en el tiempo 1 si y solo si estaba en 
# la posición (1,1) en el tiempo 0 y se movió hacia el Este en el tiempo 0 y no se movió 
# hacia el Norte en el tiempo 0.
# Sentencia 2: El Agente está en la posición (2,1) en el tiempo 1.
# Sentencia 3: El Agente en el tiempo 0 solo se ha podido mover al Este o al Norte.
# Por último, devuelve la conjunción de las sentencias anteriores.

def sentence5() -> Expr:

    A = logic.PropSymbolExpr("Agente", 1, 1, time = 0)
    B = logic.PropSymbolExpr("Agente", 2, 1, time = 0)
    C = logic.PropSymbolExpr("Norte", time = 0)
    D = logic.PropSymbolExpr("Este", time = 0)
