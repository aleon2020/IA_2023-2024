...
# PREGUNTA 6: ELIMINACIÓN DE VARIABLES

# EXPLICACIÓN DEL ALGORITMO IMPLEMENTADO:
# - Función inferenceByVariableElimination():
# En primer lugar, se guardan en la variable 'currentFactorsList' todos los factores que estén
# guardando las variables de evidencia.
# Después, se itera por todas las variables según el orden en que se vayan a eliminar,
# donde se juntan todos los factores que tiene dicha variable, además de comprobar si el factor
# sólo tiene una variable no condicionada, y, de ser así, el factor se descarta.
# Una vez hecho esto, se elimina la variable y se agrega el factor eliminado en currentFactorsList.
# Por último, ya fuera del for, se juntan todos los factores mediante la función joinFactors(),
# y la función termina devolviendo el factor normalizado.
